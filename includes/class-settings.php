...
final class Settings {
	...
	public function render_page(): void {
		...
		<div class="wrap">
			...
			<?php if ( is_array( $test_result ) ) : ?>
				<?php if ( isset( $test_result['success'] ) ) : ?>
					<div class="notice notice-success is-dismissible">
						<p><?php esc_html_e( 'Test message sent successfully.', 'telegram-order-notify' ); ?></p>
					</div>
			...
			<h2><?php esc_html_e( 'Send a test notification', 'telegram-order-notify' ); ?></h2>
			<p><?php esc_html_e( 'Click the button below to verify that your bot token and chat ID are configured correctly.', 'telegram-order-notify' ); ?></p>
